...
# Helper import function (ignores error if already imported or doesn't exist)
safe_import() {
  local resource="$1"
  local id="$2"
...
# Import IAM & ECR resources if they exist
...
# Find existing VPC with tag Name=udacity or first VPC
